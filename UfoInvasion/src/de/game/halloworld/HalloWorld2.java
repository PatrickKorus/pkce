...
/**
 * Beispiel mit Maus- und Kollsiosnsabfrage. Ein Klick auf das weiﬂe Oval z‰hlt eine
 * Punkteanzeige hoch.
 */
public class HalloWorld2 extends BasicGame {
	...
	public static void main(String[] args) throws SlickException {
		AppGameContainer container = new AppGameContainer(new HalloWorld2());
